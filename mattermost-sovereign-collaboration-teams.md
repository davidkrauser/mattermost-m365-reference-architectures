...
**Self-hosted Integrations**: Custom apps, plugins, and webhooks can be deployed within the enterprise boundary. (Optional)
...
The Mattermost server provides sovereign collaboration capabilities when deployed on enterprise-controlled infrastructure or private cloud, such as Azure or Azure Local, to maintain compliance with STIG, FedRAMP, and NIST 800-53 standards.
